...
import (
	...
	"github.com/mfojtik/depcheck/pkg/managers/godeps"
...
func (r *RepositoryWithManifest) GetVersions() error {
	...
	case ManifestTypeGodeps:
		r.Dependencies, err = godeps.ParseManifest(r.Manifests)
		fmt.Printf("%s: fetched godeps %d dependencies\n", r.URL, len(r.Dependencies))
	default:
